...
public class HexBytesUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("方法一：" + toHex(bytes));
        System.out.println("方法二：" + toHex(bytes));
        System.out.println("方法三：" + toHex(bytes));
     ...
     * @return
     */
    private static String toHexFun1(byte[] bytes) {
     ...
     * @return
     */
    private static String toHexFun2(byte[] bytes) {
        char[] buf = new char[bytes.length * 2];
        int index = 0;
     ...
     * @return
     */
    private static String toHexFun3(byte[] bytes) {

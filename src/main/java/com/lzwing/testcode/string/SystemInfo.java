...
public class SystemInfo {
    ...
    public static void showInfo() throws Exception {
        ...
        System.out.println("package: " + SystemInfo.class.getPackage().getName());

        System.out.println("package: " + SystemInfo.class.getPackage().toString());

        System.out.println("=========================");

        String packName = SystemInfo.class.getPackage().getName();
        ...
        System.out.printf("%s/%s/%n",
                ...
                (SystemInfo.class.getPackage().getName()).replaceAll("//.", "/"));
    }
}

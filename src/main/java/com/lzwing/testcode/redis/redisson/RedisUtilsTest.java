...
public class RedisUtilsTest {
	...
	public void testGetRMap() throws InterruptedException, ExecutionException {
		...
		Future<Boolean> fiveFuture= (Future<Boolean>) rMap.fastPutAsync("444", 444);
		System.out.println(fiveFuture.isSuccess());
		//异步移除key
		Future<Long> sixFuture= (Future<Long>) rMap.fastRemoveAsync("444");

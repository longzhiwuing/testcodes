package com.lzwing.testcode.encrypt;
 ...
 */
public class WechatDecriptUtil {
    // 算法名称
    ...
    private static JSONObject getDecryptedData(String sessionKey, String  encryptedData , String iv) throws Exception{
        ...
        byte[] dec = WechatDecriptUtil.decryptOfDiyIV(encryptedDataBy, sessionKeyBy,ivBy);
        String decryptedDataStr = new String(dec);

        JSONObject dataObj = JSONObject.parseObject(decryptedDataStr);

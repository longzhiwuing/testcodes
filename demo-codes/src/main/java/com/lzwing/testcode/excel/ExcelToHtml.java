...
public class ExcelToHtml {
    ...
    public static void main(String[] args) {
        ...
        //String path = "G:\\temp\\123.xlsx";// E://Microsoft Excel 工作表.xlsx
        //String outPath = "G:\\temp\\123.html";
        /*String path = "/Users/longzhiwu/downloads/t1.xlsx";
        String outPath = "/Users/longzhiwu/downloads/t1.html";*/

        String dataPath = "/Users/longzhiwu/downloads/test";


//        genHtml(path, outPath);
    }

    private static void genHtml(String path, String outPath) {
        InputStream is = null;
    ...
    /**
     * 程序入口方法将sourceFile文件保存为html并存入resultFile
     * @param sourceFile
     * @param resultFile
     * @param isWithStyle
     * @return
     */
    public String readExcelToHtml(File sourceFile, File resultFile, boolean isWithStyle) {
        logger.debug("ExcelToHtml:fileName="+sourceFile.getName());
        InputStream is = null;
        String htmlExcel = null;
        Writer or = null;
        BufferedWriter bor = null;
    ...
    public static String getExcelInfo(Workbook wb, boolean isWithStyle) {
        ...
        sb.append("<table style='border-collapse:collapse;' width='800px;'>");
        Row row = null; // 兼容
        Cell cell = null; // 兼容

...
public class EncodingDetect {
    public static void main(String[] args) throws Exception{
        ...
        String encode = getJavaEncode(filePath);
        System.out.println("encode:"+encode);


        IOUtils.copy(FileUtils.openInputStream(new File(filePath)), System.out);

        System.out.println(FileUtils.readFileToString(new File(filePath),EncodingDetect.getJavaEncode(filePath)));
    }
